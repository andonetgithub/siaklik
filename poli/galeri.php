        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <ul class="custom-logo">
                    ...
                    <li class="custom-logo-child">
                        <a class="logo-text custom-text-head" href="../index.php">SIKK</a><br><span class="span-logo" style="color:white;">SISTEM INFORMASI KLINIK KECANTIKAN</span></span></a>
                    </li>
                </ul>
            </div>
                ...
                <section id="galery-foto">
                    <div class="custom-header header-wrapper" align="center">
                        ...
                        <article id="3685" class="location-listing">
                            <a class="location-title" href="../assets/images/gallery/1.jpg">Profil Tempat Klinik</a>
                            <div class="location-image">
                                <a href="#"><img class="img-size" src="../assets/images/1.jpg" alt="pict1"></a>
                            </div>
                        </article>

                        <article id="3688" class="location-listing">
                            <a class="location-title" href="../assets/images/gallery/2.jpg">Profil Produk Klinik</a>
                            <div class="location-image">
                                <a href="#"><img class="img-size" src="../assets/images/2.jpg" alt="pict2"></a>
                            </div>
                        </article>

                        <article id="3691" class="location-listing">
                            <a class="location-title" href="../assets/images/gallery/3.jpg">Ruang Perawatan</a>
                            <div class="location-image">
                                <a href="#"><img class="img-size" src="../assets/images/3.jpg" alt="pict3"></a>
                            </div>
                        </article>

                        <article id="3694" class="location-listing">
                            <a class="location-title" href="../assets/images/gallery/5.jpg">Ruang Tunggu</a>
                            <div class="location-image">
                                <a href="#"><img class="img-size" src="../assets/images/5.jpg" alt="pict4"></a>
                            </div>
                        </article>
