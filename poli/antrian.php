        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <ul class="custom-logo">
                    ...
                    <li class="custom-logo-child">
                        <a class="logo-text custom-text-head" href="../index.php">SIKK<br><span class="span-logo" style="color:white;">SISTEM INFORMASI  KLINIK KECANTIKAN</span></a>
                    </li>
                    <?php
            ...
            <ul class="list-unstyled components custom-menu-bar">
                ...
                <li class="custom-menu-sidebar">
                    ...
                    <ul class="collapse list-unstyled" id="pageArtikel">
                        <li>
                            <a href="https://drive.google.com/file/d/13-_d4f0jVqUxXbsCsPgxu9G06VDtSYl8/view?usp=sharing"><i class="fas fa-bookmark"></i>SULAM ALIS</a>
                        </li>
                        <li>
                            <a href="https://drive.google.com/file/d/1rV3hmPzLj23wYye-kUuQfx0lTYijOmyk/view?usp=sharing"><i class="fas fa-bookmark"></i>SUNTIK PEMUTIH</a>
                        </li>
                        <li>
                            <a href="https://drive.google.com/file/d/1kdXjK6Ovts0oAdcbTjktqqdDY3jfmnVX/view?usp=sharing"><i class="fas fa-bookmark"></i>FILER BIBIR</a>
                        </li>
                        <li>
                            <a href="https://drive.google.com/file/d/13SHcHyXvEo89jHzVOtQuoCMFWDuKX7Mu/view?usp=sharing"><i class="fas fa-bookmark"></i>FILER WAJAH</a>
                        </li>
                        <li>
                            <a href="https://drive.google.com/file/d/195VIxg5VTICQ1tMHuePBicq5Tl1ApWsp/view?usp=sharing"><i class="fas fa-bookmark"></i>LASER</a>
                        </li>
                ...
                <li class="custom-menu-sidebar">
                    ...
                    <ul class="collapse list-unstyled" id="pageContact">
                        <li>
                            <a href="#"><i class="fas fa-phone-alt"></i>Contact : 083246789523</a>
                        </li>
                        <li>
                			...
                			<form action="../cruds/input_umum.php" method="POST">
                    			<div class="modal-body">
                                    ...
                                    <table id="datatableid" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td> <input style="text-align: center;" type="text" name="tindakan2"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                				</div>
            ...
            <div class="table-responsive">
                ...
                <table id="datatableid" class="table table-bordered" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th scope="col" style="padding:10px;">TINDAKAN</th>
                    ...
                    <?php
                        ...
                        if(isset($_POST['searchdata1'])){
                            if($inputsrdata1 != ""){
                                $query_search1 = mysqli_query($koneksi,"SELECT * FROM antrian_umum WHERE id_antrian like '%".$inputsrdata1."%' OR kode_antrian like '%".$inputsrdata1."%' OR nama_pasien like '%".$inputsrdata1."%' OR tindakan like '%".$inputsrdata1."%'") OR die(mysql_error());
                    ...
                    <tr>
                        ...
                        <td data-label="tindakan" style="padding:5px;"> <?php echo $row['tindakan']; ?> </td>
                    </tr>
                    </tbody>
